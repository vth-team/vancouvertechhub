...
Being experts in Rails, Ember.js and Angular we also offer the ability to nurture and clean up code. We do this by working with you directly and train by doing vs consulting a day or two."', employee_count: 10, tech_team_size: 10, website: 'http://brewhouse.io', twitter: 'brewhouseteam', published: false)

o8 = Organization.create(name: 'Trulioo', address: '420 W Hastings St #300, Vancouver, BC V6B 1L1, Canada', overview: 'Trulioo is a leading global ID verification company providing advanced analytics based on traditional information such as public records, credit files and government data as well as alternative sources including social login providers, ad networks, mobile applications, e-commerce websites and social networks.', employee_count: 45, tech_team_size: 45, website: 'https://www.trulioo.com/', twitter: 'trulioo', published: false)

o9 = Organization.create(name: 'ZOZI', address: '1 Beach St #300, San Francisco, CA 94133, United States', overview: 'Trulioo is a leading global ID verification company providing advanced analytics based on traditional information such as public records, credit files and government data as well as alternative sources including social login providers, ad networks, mobile applications, e-commerce websites and social networks.', employee_count: 100, tech_team_size: 100, website: 'https://www.zozi.com/
', twitter: 'zozi', published: false)

o10 = Organization.create(name: 'Venzee', address: '375 Water Street Vancouver, BC V6B 5C6, Canada.', overview: '"90% of suppliers and manufacturers still use spreadsheets to share critical information about their products with their retailers. For decades, spreadsheets have been used as costly, inefficient bandaids to fix data flow. Even NASA and the White House use spreadsheets when systems are too expensive or impossible to integrate."', employee_count: 20, tech_team_size: 20, website: 'https://venzee.com', twitter: 'venzeedev', published: false)

o11 = Organization.create(name: 'Payfirma', address: '885 W Georgia St #1200, Vancouver, BC V6C 3E8, Canada', overview: '"Payfirma helps you accept credit card payments online, in your store, and on your mobile device. Our cloud platform processes your payments and puts all your transaction data in one place. With everything in one place, you can use your data to make smarter business decisions about your customers, products, and employees. Our customers tell us that we are the best payments company they\'ve worked with and we continually work hard to keep them happy."', employee_count: 60, tech_team_size: 60, website: 'https://www.payfirma.com/', twitter: 'payfirma', published: false)

o12 = Organization.create(name: 'Food.ee', address: '120 Columbia St, Vancouver, BC V6A 3Z8, Canada', overview: 'Foodee works with the city\'s best restaurants to provide delicious, healthy, and sustainable food to the best teams. We believe every meal should be made with fresh, local ingredients and always provide exceptional taste. Eating great food with your team improves communication, productivity, and most importantly provides quality team time.', employee_count: 70, tech_team_size: 70, website: 'https://www.food.ee/', twitter: 'foodee', published: false)

o13 = Organization.create(name: 'SKIO Music', address: '390 Cambie St, Vancouver, BC V6B 2N3, Canada', overview: 'SKIO Music is a collaboration platform that empowers creatives by making music licensing in the digital era more efficient, transparent and fair, allowing artists to focus more on creating.', employee_count: 20, tech_team_size: 20, website: 'https://skiomusic.com/', twitter: 'skiomusic', published: false)

o14 = Organization.create(name: '14 Oranges', address: '3820 Cessna Dr #295, Richmond, BC V7B 0A2, Canada', overview: '"14 Oranges provides mobile and web application development services. Our goal is to delight our customers with the best mobile and web applications in the market. We offer full end-to-end solutions, including web, back-end, and app interface design, to companies of all sizes: from small businesses to large enterprises."', employee_count: 12, tech_team_size: 12, website: 'http://www.14oranges.com/', twitter: '14oranges', published: false)

o14 = Organization.create(name: 'Unbounce', address: '401 W Georgia St, Vancouver, BC V6B 5A1, Canada', overview: 'Unbounce lets marketers build, publish and test landing pages without IT or software. A/B testing and lead gen make it a powerful marketing tool.', employee_count: 140, tech_team_size: 140, website: 'http://unbounce.com/', twitter: 'unbounce', published: false)
...
o16 = Organization.create(name: 'Battlefly', address: '225 Smithe St #201, Vancouver, BC V6B 4X7, Canada', overview: '"Battlefy is the simplest way to start, manage, and find esports tournaments | Create. Compete. Conquer."', employee_count: 20, tech_team_size: 20, website: 'https://battlefy.com/', twitter: 'battlefly', published: false)

o17 = Organization.create(name: 'RosterBot', address: 'n/a', overview: 'RosterBot is the world\'s most advanced team management service, and is used by more than 10,000 teams in 60+ countries, for more than 400 different types of sports and activities.  RosterBot also happens to be a free service and is led and backed by seasoned technology industry entrepreneurs and NHL veterans.', employee_count: 7, tech_team_size: 7, website: 'http://www.rosterbot.com', twitter: 'rosterbot', published: false)

o18 = Organization.create(name: 'Medeo', address: '208 - 128 West 6th Ave., Vancouver, BC V5Y 1K6, Canada', overview: '"Medeo is QHR\'s virtual care technology which connects health providers with their patients online for private video visits, secure messaging, and other virtual care applications. Medeo gives health providers the freedom to practice anywhere, any time. Patients are able to connect with their health providers via smartphone (iOS or Android), tablet, or computer."', employee_count: 5, tech_team_size: 5, website: 'https://medeo.ca/', twitter: 'medeo', published: false)

o19 = Organization.create(name: 'Drive Digital', address: '404 - 1120 Hamilton St, Vancouver, BC V6B 2S2, Canada', overview: '"Drive Digital is a boutique web design agency specializing in web strategy, usability, creative, design and development of amazing websites and applications."', employee_count: 27, tech_team_size: 27, website: 'http://www.drivedigital.ca', twitter: 'drive_digital', published: false)

o20 = Organization.create(name: 'Robot Overlord', address: 'n/a', overview: 'Robot Overlord is a holistic software agency focusing on best-in-class technologies, human-computer interaction (HCI+UX), and team well-being. Steve is not a robot.', employee_count: 4, tech_team_size: 4, website: 'http://http://www.robotoverlord.io/', twitter: 'hailrobo', published: false)
