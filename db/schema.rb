...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 20160508224408) do
=======
ActiveRecord::Schema.define(version: 20160509013954) do
>>>>>>> style and add new table field in event for admin page use
